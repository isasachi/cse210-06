...
class Scene(ActionCallback):
    ...
    def on_next(self, scene):
        ...
        """
        self._scene_manager.prepare_scene(scene, self._collection, self._script)
    ...
    def _execute_actions(self, group):
        ...
        for action in actions:
            action.execute(self._collection, self._script, self)